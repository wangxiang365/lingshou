    ...
    <ul>
      ...
      <li>
        <router-link to="/AllCategories">
          ...
          <img src="../../assets/images/Type_active.png">
          <div>全部商家</div>
        </router-link>
      </li>
      <li>
        <router-link to="/MyCoupon">
          ...
          <img src="../../assets/images/Coupon_active.png">
          <div>我的优惠券</div>
        </router-link>
      </li>
      <li>
...
<style scoped>
  .footer ul li a img:nth-child(1){
    display: inline-block;
  }
  .footer ul li a img:nth-child(2){
    display: none;
  }
  .footer ul li a.active  img:nth-child(1){
    display: none;
  }
  .footer ul li a.active img:nth-child(2){
    display: inline-block;
  }
  .footer ul li a.active div{
    color: #06c1ac;
  }
  .footer{
    width:7.5rem;
